  ...
  <body>
    ...
    <div class="conatainer p-lg-5">
        ...
        <div>
            ...
            @endif
            <form action="/meals/store" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-12 text-center mx-auto">
                        <div>
                            <label for="meal_name">Meal name</label>
                            <input type="text" id="meal_name" name="meal_name" placeholder="Enter meal name">
                        </div>
                        <br>
                        <div>
                            <label for="meal_price">Meal Price</label>
                            <input type="text" id="meal_price" name="meal_price" placeholder="Enter Meal price">
                        </div>
                        <br>
                    </div>
                </div>
